...
.service('PitchesResource', function ($cachedResource, UserService, Utils) {
  return $cachedResource('resource.pitches', Utils.getApiUrl() + '/pitches/:community/:category/:id', { id: '@id', community: '@community', category: '@category', access_token: UserService.user().accessToken }, {
